...
export default function TranscriptView({
  ...
  if (transcriptionStatus === "processing" || transcribing) {
    return (
      <div className="glass-card rounded-2xl overflow-hidden stagger">
        <div className="px-5 py-3 flex items-center justify-between border-b border-white/5">
          <h2 className="text-[11px] font-semibold text-white/50 uppercase tracking-wider">Transcricao</h2>
        </div>
    ...
    return (
      <div className="glass-card rounded-2xl overflow-hidden stagger">
        ...
        <div className="flex flex-col items-center gap-3 p-8">
          <p className="text-red-500 text-[12px]">A transcricao falhou.</p>
          <button
  ...
  if (transcriptionStatus === "pending" || (!transcript && transcriptionStatus !== "done")) {
    return (
      <div className="glass-card rounded-2xl overflow-hidden stagger">
        ...
        <div className="flex flex-col items-center gap-3 p-8">
          <p className="text-white/30 text-[12px]">Nenhuma transcricao disponivel.</p>
          <button
    ...
    return (
      <div className="glass-card rounded-2xl overflow-hidden stagger">
        <div className="px-5 py-3 flex items-center justify-between border-b border-white/5">
          <h2 className="text-[11px] font-semibold text-white/50 uppercase tracking-wider">Transcricao</h2>
          <button
            className="text-[10px] text-white/20 hover:text-white/50 transition-colors bg-transparent border-0 cursor-pointer"
            onClick={handleTranscribe}
          >
            Retranscrever
          </button>
    ...
    <div className="glass-card rounded-2xl overflow-hidden stagger">
      ...
      {transcript ? (
        ...
        <div className="flex items-center justify-center p-8">
          <p className="text-white/30 text-[12px]">Transcricao concluida, mas sem conteudo disponivel.</p>
        </div>
      )}
    </div>
  );
